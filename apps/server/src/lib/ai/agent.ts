...
const SYSTEM_PROMPT =
  ...
  'content is markdown. Tools that return a paged list -- search_pages, ' +
  'list_children, list_trash, query_database -- return one page of it as ' +
  ...
  'page. list_databases returns a plain array of every database you can ' +
  'open. After you have made the requested change, reply with ' +
